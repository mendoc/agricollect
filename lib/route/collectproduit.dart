...
class CollectProduit extends StatefulWidget {
  @override
  _CollectProduitState createState() => _CollectProduitState();
}

class _CollectProduitState extends State<CollectProduit> {
  @override
                ...
                child: Padding(
                  ...
                  child: Card(
                    child: Column(
                      children: <Widget>[
                        ListTile(
                          title: Text("Production", style: TextStyle(fontSize: 20)),
                        ),
                        Divider(),
                        Form(
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  decoration: InputDecoration(
                                      hintText:
                                          "Renseignez l'unité de production",
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  decoration: InputDecoration(
                                      hintText: "Renseignez la quantité produite",
                                      prefixIcon: Icon(Icons.attach_money)),
                                  validator: (value) {
                                    if (value.isEmpty) {
                                      return 'Enter some text';
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  decoration: InputDecoration(
                                      hintText: "Renseignez la perte de quantité",
                                      prefixIcon: Icon(Icons.attach_money)),
                                  validator: (value) {
                                    if (value.isEmpty) {
                                      return 'Enter some text';
