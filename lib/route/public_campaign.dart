...
class PublicCampaign extends StatefulWidget {
  @override
  _PublicCampaignState createState() => _PublicCampaignState();
}

class _PublicCampaignState extends State<PublicCampaign> {
  @override
